...
public class UpdatePictureLecturerActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.menuhomepagelecturer:
                startActivity(new Intent(UpdatePictureLecturerActivity.this, HomePageLecturerActivity.class));
                return true;
    ...
    private void Logout(){
        ...
        finish();
        startActivity(new Intent(UpdatePictureLecturerActivity.this, LoginActivity.class));
    }
}