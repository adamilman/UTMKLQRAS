...
public class UpdatePictureAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_picture_admin);
            ...
            public void onClick(View v) {
                ...
                uploadTask.addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(UpdatePictureAdminActivity.this,"Upload Failed", Toast.LENGTH_SHORT).show();
                    }
                }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    @Override
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        progressDialog.dismiss();
                        Toast.makeText(UpdatePictureAdminActivity.this,"Upload Successful", Toast.LENGTH_SHORT).show();
                        startActivity(new Intent(UpdatePictureAdminActivity.this, ProfileAdminActivity.class));
                    }
                });
            }
        });
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.menuhomepageadmin:
                startActivity(new Intent(UpdatePictureAdminActivity.this, HomePageAdminActivity.class));
                return true;
    ...
    private void Logout(){
        ...
        finish();
        startActivity(new Intent(UpdatePictureAdminActivity.this, LoginActivity.class));
    }
}