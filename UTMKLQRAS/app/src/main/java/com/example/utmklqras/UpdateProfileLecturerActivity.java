...
public class UpdateProfileLecturerActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.menuhomepagelecturer:
                startActivity(new Intent(UpdateProfileLecturerActivity.this, HomePageLecturerActivity.class));
                return true;
    ...
    private void Logout(){
        ...
        finish();
        startActivity(new Intent(UpdateProfileLecturerActivity.this, LoginActivity.class));
    }
}